...
$execute store result bossbar dynamic_bossbars:$(bossbar_id) value run $(value_setter)
$execute store result bossbar dynamic_bossbars:$(bossbar_id) max run $(max_setter)
